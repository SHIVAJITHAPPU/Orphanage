            ...
            Container(
              child: Center(
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                 Navigator.push(context, MaterialPageRoute(builder: (context)=>CHILDSV()));
                  },
                  icon: Icon(Icons.edit,color: Colors.black,), // Icon you want to add
                  label: Text('Edit/Update',style: TextStyle(color: Colors.black),),
              ...
              child: ElevatedButton(
                style: ElevatedButton.styleFrom(
                  ...
                  foregroundColor: Colors.red,
                    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30),side: BorderSide(color: Colors.red))

                ),
                onPressed: () {},
                child: Text('Remove child',style: TextStyle(fontSize: 23),),
