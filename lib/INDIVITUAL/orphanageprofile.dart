...
import 'indChildDtls.dart';
class ORPHANAGEPROFILE extends StatefulWidget {
  const ORPHANAGEPROFILE({super.key});

  @override
  State<ORPHANAGEPROFILE> createState() => _ORPHANAGEPROFILEState();
}
            ...
            children: [
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context)=>IND_CHILD_DETAILS()));
                  },
